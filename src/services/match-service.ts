...
const URLS = {
  POIS: 'REPLACE_WITH_YOUR_GOOGLE_SHEETS_CSV_URL_FOR_POIS',
  MATCHES: 'REPLACE_WITH_YOUR_GOOGLE_SHEETS_CSV_URL_FOR_MATCHES',
  TIMELINE: 'REPLACE_WITH_YOUR_GOOGLE_SHEETS_CSV_URL_FOR_TIMELINE'
};
